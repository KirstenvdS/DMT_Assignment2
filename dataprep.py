...
def remove_outliers(df):
    ...
    plt.boxplot(df[["price_usd", "srch_length_of_stay"]], labels=["price_usd", "srch_length_of_stay"]) # outliers > 10,000
    ...
    # TODO: assert that for each search id, all search attributes remain the same
